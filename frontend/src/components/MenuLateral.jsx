        ...
        <section className="w-75 py-12 px-2 h-screen shadow-lg bg-MainBackground flex flex-col justify-between">
                ...
                <nav class="w-full mt-12">
                    <ul class="py-6 space-y-2 font-medium">
                        <li><a href="#" class="flex items-center gap-2 px-6 py-4 group hover:scale-[1.02] hover:-translate-x-1 transition-all duration-300 ease-out overflow-hidden  text-Paragraf hover:bg-BlueHover/10 hover:text-BlueHover rounded-r-lg">
